    ...
    <section id="home" className="min-h-screen flex items-center justify-center text-center md:text-left relative overflow-hidden">
        <div className="container mx-auto px-6 py-20 grid md:grid-cols-5 gap-8 items-center relative z-10">
            ...
            >
                ...
                />
                <img src="src/costas.png" onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/400x400/e2e8f0/334155?text=CP' }} alt="Costas Pinto" className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px] shadow-2xl"/>
            </motion.div>
        </div>
    </section>
);
